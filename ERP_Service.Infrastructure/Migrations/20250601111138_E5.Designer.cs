...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP_Service.Domain.Models.Customers.ShippingAddress", b =>
                {
            ...
            modelBuilder.Entity("ERP_Service.Domain.Models.Orders.BundleDiscountItem", b =>
                {
                    ...
                    b.Property<int>("BundleDiscountId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP_Service.Domain.Models.Orders.VolumeDiscountItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP_Service.Domain.Models.InboundReceipts.InboundReceipt", b =>
                {
                    ...
                    b.HasOne("ERP_Service.Domain.Models.InboundReceipts.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP_Service.Domain.Models.Orders.BundleDiscountItem", b =>
                {
                    b.HasOne("ERP_Service.Domain.Models.Orders.BundleDiscount", "BundleDiscount")
                        .WithMany("BundleDiscountItems")
                        .HasForeignKey("BundleDiscountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP_Service.Domain.Models.Orders.Order", b =>
                {
                    ...
                    b.HasOne("ERP_Service.Domain.Models.Customers.ShippingAddress", "ShippingAddress")
                        .WithMany("Orders")
